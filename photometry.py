...
if DISP:
  ...
  ds9.set('tile grid')
#------------------------------------------------------------------------------------#
HICAT=ad.open('/Users/khaled/Desktop/PhD/IRSF/phd_n/lists/hicatlist')
hidat = ad.open('/Users/khaled/Desktop/PhD/IRSF/phd_n/lists/masterHIv',delimiter='|')
...
stamppath = '/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/stamps/'
ellpath = '/Users/khaled/Desktop/PhD/IRSF/phd_n/reduction/phot/SBPs/'
outcatpath = '/Users/khaled/Desktop/PhD/IRSF/phd_n/reduction/phot/cats/'

# global image parameters
#expos = 24.	# exposure time
ps = 0.2	# Which survey? what is the pixel scale?
...
def photloop(Jimage_nir,ra0,dec0,a,b,Gpa):
  ...
  ellfig = pl.figure(figsize=(10,10))  #pa/ellipticity fig
  ...
  catfile = open(outcatpath+Jimage_nir+'.nircat','w')
  # write to cat file
...
if os.path.isfile(NIRCATfile): NIRCAT = open(NIRCATfile,'a')
else: NIRCAT = open(NIRCATfile,'w')
NIRCAT.close()
