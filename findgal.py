# interactively look at fields/field info/3 color fits images to search for galaxies, mark positions
...
def showHIdat(field):
    ...
    spfile='/Users/khaled/Desktop/PhD/IRSF/phd/lists/HI/spectra/'+field+'.ps'
	...
	for i in range(len(list2mass)):
	    print list2mass[i]
	    tmfile='/Users/khaled/Desktop/PhD/IRSF/phd/lists/2MASS/images/'+list2mass[i]+'.jpg'
	    os.system('xv '+tmfile+' &') 
...
pspath='/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/ps/'

masterlist='/Users/khaled/Desktop/PhD/IRSF/phd/lists/masterHI'
masterdat=ad.open(masterlist,delimiter='|')

Lastfield=-1
fieldlistname='/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/calibrated_list'
lastfieldlist = '/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/lastfield'
...
while True:
	...
	if fieldlistname == 'all':
	    fieldlistname = '/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/images1007/list1007'
	    lastfieldlist = '/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/images1007/list1007_last'
	    catpath = '/Users/khaled/Desktop/PhD/IRSF/phd_n/IRSFdata/images1007/'
	if fieldlistname in ['norma','Norma']:
	    fieldlistname='/Users/khaled/Desktop/PhD/IRSF/phd/IRAC/IRSF/normafieldlist'
	    savelastfield=False
	    Lastfield=-1
